...
<ins> relay </ins>: Variable que representa el puerto de salida conectado a la base del transistor que controlará el estado del relay. Si relay=0, éste no ha sido activado y se encontrará cerrado, dado que es normalmente cerrado; si relay=1, el relé se abrirá, y por ende el auto se apagará y no podra ser encendido.

<ins> tiempo </ins>: Variable que funcionará como contador de tiempo.

<ins> t_set </ins>: Valor constante que se comparará con la variable "tiempo", y determinará cuanto tiempo transcurrirá hasta que se apague el auto, dadas las condiciones necesarias.
