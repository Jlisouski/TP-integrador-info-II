 ...
 **Explicación de estados:**
 ...
 <ins> Estado 2: </ins>En este estado, el valor de mem=1. La variable "tiempo" comenzaría a contar, y su valor se comparará constantemente con "t_set". Si tiempo<t_set, sigue en el mismo estado; si tiempo>t_set, prosigue al estado 1.
